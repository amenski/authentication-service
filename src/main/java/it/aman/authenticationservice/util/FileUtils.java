...
public final class FileUtils {
    ...
    /**
     * Upload file to a path. File name will hold the form [filename + UserName +
     * date]
     * 
     * @param fullFileName
     * @param uploadDir
     ...
     * @throws Exception
     */
    public static byte[] resizeImageAsThumbnails(InputStream inputStream, String extension, int[] widthHeight)
            throws IOException {
